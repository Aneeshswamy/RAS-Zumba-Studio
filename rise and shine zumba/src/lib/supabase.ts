...
export const SECTION_CONFIGS: Record<string, SectionConfig> = {
  hero: {
    label: "Home — Hero Banner", icon: "🎯", color: "bg-purple-500",
  ...
  stats: {
    label: "Home — Stats Strip", icon: "📊", color: "bg-indigo-500",
    description: "Fire-themed stats strip on the Home page",
    fields: [
      { key: "statItems", label: "Stats (NUMBER|LABEL)", type: "pair-list", max: 5 },
    ],
  },
  testimonials: {
    label: "Home — Testimonials", icon: "💬", color: "bg-purple-400",
    description: "Scrolling feedback marquee on the Home page",
    fields: [
      { key: "quotes", label: "Quotes (one per line)", type: "list", max: 15 },
    ],
  },
  services_hero: {
    label: "Services — Hero", icon: "🚀", color: "bg-blue-500",
  ...
  about: {
    label: "About — Our Story", icon: "📖", color: "bg-teal-500",
  ...
  about_founder: {
    label: "About — Founder", icon: "👤", color: "bg-teal-600",
  ...
  instructors: {
    label: "About — Trainers", icon: "👥", color: "bg-blue-500",
  ...
  about_transformations: {
    label: "About — Transformations", icon: "✨", color: "bg-orange-500",
  ...
  dance: {
    label: "Dance — Intro", icon: "💃", color: "bg-pink-500",
  ...
  dance_hiphop: {
    label: "Dance — Hip-Hop", icon: "🎤", color: "bg-pink-600",
  ...
  dance_bollywood: {
    label: "Dance — Bollywood", icon: "🎬", color: "bg-pink-600",
  ...
  dance_classical: {
    label: "Dance — Classical", icon: "🏛️", color: "bg-pink-600",
  ...
  dance_contemporary: {
    label: "Dance — Contemporary", icon: "🌊", color: "bg-pink-600",
  ...
  fitness: {
    label: "Fitness — Intro", icon: "🏋️", color: "bg-orange-500",
  ...
  fitness_zumba: {
    label: "Fitness — Zumba", icon: "🎵", color: "bg-orange-600",
  ...
  fitness_aerobics: {
    label: "Fitness — Aerobics", icon: "🏃", color: "bg-orange-600",
  ...
  fitness_yoga: {
    label: "Fitness — Yoga", icon: "🧘", color: "bg-orange-600",
  ...
  fitness_weightloss: {
    label: "Fitness — Weight Reduction", icon: "📉", color: "bg-orange-600",
  ...
  fitness_toning: {
    label: "Fitness — Body Toning", icon: "💪", color: "bg-orange-600",
  ...
  events: {
    label: "Events — Intro", icon: "🎪", color: "bg-yellow-500",
  ...
  events_professional: {
    label: "Events — Pro Group", icon: "🌟", color: "bg-yellow-600",
  ...
  events_sangeet: {
    label: "Events — Sangeet", icon: "💒", color: "bg-yellow-600",
  ...
  events_corporate: {
    label: "Events — Corporate", icon: "🏢", color: "bg-yellow-600",
  ...
  events_flashmob: {
    label: "Events — Flash Mobs", icon: "⚡", color: "bg-yellow-600",
  ...
  events_all: {
    label: "Events — All Others", icon: "🌍", color: "bg-yellow-600",
  ...
  pricing_spark: {
    label: "Pricing — Spark", icon: "✨", color: "bg-green-500",
  ...
  pricing_blaze: {
    label: "Pricing — Blaze", icon: "🔥", color: "bg-green-600",
  ...
  pricing_inferno: {
    label: "Pricing — Inferno", icon: "🌋", color: "bg-red-500",
  ...
  gallery: {
    label: "Gallery — About Page", icon: "🖼️", color: "bg-pink-500",
  ...
  dance_gallery: {
    label: "Gallery — Dance Page", icon: "🎥", color: "bg-pink-600",
  ...
  fitness_gallery: {
    label: "Gallery — Fitness Page", icon: "🎥", color: "bg-orange-600",
  ...
  events_gallery: {
    label: "Gallery — Events Page", icon: "🎥", color: "bg-yellow-600",
  ...
  acting_gallery: {
    label: "Gallery — Acting Page", icon: "🎥", color: "bg-purple-600",
  ...
  contact: {
    label: "Global — Contact Info", icon: "📞", color: "bg-slate-500",
...
export const PULSE_SEED: SeedRow[] = [
  ...
  { section_key: "dance_gallery", section_label: "Gallery — Dance", title: "Dance Gallery", body: "", image_url: null, button_text: null, button_link: null, is_visible: true, sort_order: 30, meta: { media: ["/videos/475521.mp4", "/videos/475523 (1).mp4", "https://youtube.com/shorts/rvwzbcawzWY?feature=share", "https://youtube.com/shorts/hQ_cWr5rlNM", "/videos/475529 (3).mp4"] } },
